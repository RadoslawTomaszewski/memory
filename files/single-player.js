const win = new Audio("audio/win_eevee.mp3");
const lose = new Audio("audio/lose_eevee.mp3");
...
function hide2Cards(nr1, nr2){
	...
	if(pairsLeft==0){
		...
		if(turnCounter<20) {
			document.querySelector('.board').innerHTML = '<img src="img/win.gif"/><h1>You win!<br/>Done in ' + turnCounter + ' turns!';
			win.play();
			return;
		}

		document.querySelector('.board').innerHTML = '<img src="img/lose.gif"/><h1>Boomer!<br/>Done in ' + turnCounter+ ' turns!';
		lose.play();
	}
